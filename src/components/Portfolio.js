...
const projects = [
  ...
  },
  {
    ...
    website: 'https://vicinitiee.herokuapp.com/login',
    code: undefined,
    description: 'A platform for event company to make reservations and managing their day-to-day business activities.',
    year: 2019,
          ...
          <li className="card">
            <div className="card_content">
              ...
              <div className='card_action'>
                {proj.website && <span>Demo</span>}
                {proj.code && <span>Code</span>}
              </div>
            </div>
          </li>
        ))}
